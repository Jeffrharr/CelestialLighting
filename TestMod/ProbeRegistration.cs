...
public static class ProbeRegistration
{
    static ProbeRegistration()
    {
        ...
        // §26, defaulting FALSE — and now the odd one out on this stretch, since §25 above just
        // started shipping on. Not one of the cloud lanes despite sitting next to them: it shares
        // their twilight window but reads no cloud fraction, so a scenario can film the sweep over a
        // cloudless evening with all three of the above off.
        FeatureRegistry.Register(
