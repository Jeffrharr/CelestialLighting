...
// Kept as its own file even though there is only one caller: the next patch that needs a Section
// from a SectionLayer should reuse this rather than reinvent the FieldRef.
